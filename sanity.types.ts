...
// Variable: PUBLISHED_CASE_STUDIES_QUERY
// Query: *[_type == "caseStudy" && status == "published"] | order(publishedAt desc, featured desc)[0...$limit]{    _id,    language,    title,    excerpt,    slug,    status,    publishedAt,    featured,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt,      caption    },    authors[]{      userId,      name,      email,      role,      affiliation->{        _id,        name,        slug,        acronym,        logo{          asset->{            _id,            url          },          alt        }      }    },    organizations[]->{      _id,      name,      slug,      acronym,      logo{        asset->{          _id,          url        },        alt      }    },    projects[]->{      _id,      name,      slug    },    tags,    studyPeriod,    studyLocation,    studyAreas[]{      location,      name,      description    }  }
export type PUBLISHED_CASE_STUDIES_QUERYResult = Array<never>;
// Variable: APPROVED_CASE_STUDIES_BY_RC_QUERY
// Query: *[_type == "caseStudy" && status == "approved" && references(*[_type == "regionalCommunity" && slug.current == $slug][0]._id)] | order(publishedAt desc, featured desc)[0...$limit]{    _id,    language,    title,    excerpt,    slug,    status,    publishedAt,    featured,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt,      caption    },    authors[]{      userId,      name,      email,      role,      affiliation->{        _id,        name,        slug,        acronym,        logo{          asset->{            _id,            url          },          alt        }      }    },    organizations[]->{      _id,      name,      slug,      acronym,      logo{        asset->{          _id,          url        },        alt      }    },    projects[]->{      _id,      name,      slug    },    tags,    studyPeriod,    studyLocation,    studyAreas[]{      location,      name,      description    }  }
export type APPROVED_CASE_STUDIES_BY_RC_QUERYResult = Array<never>;
// Variable: CASE_STUDY_BY_SLUG_QUERY
// Query: *[_type == "caseStudy" && slug.current == $slug][0]{    _id,    language,    title,    excerpt,    content,    slug,    status,    publishedAt,    submittedAt,    submittedBy,    featured,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt,      caption    },    authors[]{      userId,      name,      email,      role,      affiliation->{        _id,        name,        slug,        acronym,        logo{          asset->{            _id,            url          },          alt        }      }    },    organizations[]->{      _id,      name,      slug,      acronym,      logo{        asset->{          _id,          url        },        alt      }    },    projects[]->{      _id,      name,      slug    },    tags,    studyPeriod,    studyLocation,    studyAreas[]{      location,      name,      description    },    // Translation management    baseDocument->{      _id,      language,      slug,      title    },    translations[]{      language,      translationStatus,      document->{        _id,        language,        slug,        title      }    },    // SEO fields    seoTitle,    seoDescription,    canonicalUrl  }
export type CASE_STUDY_BY_SLUG_QUERYResult = null;
// Variable: FEATURED_CASE_STUDIES_QUERY
// Query: *[_type == "caseStudy" && status == "published" && featured == true] | order(publishedAt desc)[0...$limit]{    _id,    language,    title,    excerpt,    slug,    publishedAt,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt,      caption    },    authors[]{      name,      role,      affiliation->{        name,        acronym      }    },    tags  }
export type FEATURED_CASE_STUDIES_QUERYResult = Array<never>;
// Variable: CASE_STUDIES_BY_LANGUAGE_QUERY
// Query: *[_type == "caseStudy" && status == "published" && language == $language] | order(publishedAt desc)[0...$limit]{    _id,    language,    title,    excerpt,    slug,    publishedAt,    featured,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt,      caption    },    authors[]{      name,      role,      affiliation->{        name,        acronym      }    },    tags  }
export type CASE_STUDIES_BY_LANGUAGE_QUERYResult = Array<never>;
// Variable: CASE_STUDIES_WITH_TRANSLATIONS_QUERY
// Query: *[_type == "caseStudy" && language == "en"] | order(publishedAt desc, _createdAt desc)[0...$limit]{    _id,    language,    title,    excerpt,    slug,    status,    publishedAt,    featured,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt,      caption    },    authors[]{      name,      role,      affiliation->{        name,        acronym      }    },    translations[]{      language,      translationStatus,      document->{        _id,        language,        slug,        title,        status,        publishedAt      }    }  }
export type CASE_STUDIES_WITH_TRANSLATIONS_QUERYResult = Array<never>;
// Variable: CASE_STUDY_TRANSLATIONS_QUERY
// Query: {    "base": *[_type == "caseStudy" && _id == $baseId][0]{      _id,      language,      title,      slug,      status,      publishedAt    },    "translations": *[_type == "caseStudy" && baseDocument._ref == $baseId]{      _id,      language,      title,      slug,      status,      publishedAt    }  }
export type CASE_STUDY_TRANSLATIONS_QUERYResult = {
  base: null;
